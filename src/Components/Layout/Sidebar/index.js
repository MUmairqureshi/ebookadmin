    ...
    <div className={`sidebar ${props.sideClass}`} id="sidebar">
      <ul className="list-unstyled">
        ...
        <li className="sidebar-li">
          <Link
            className={`sideLink ${
              location.pathname.includes("/series-management") ? "active" : ""
            }`}
          ...
          >
            ...
            <span className="sideLinkText">Series Management</span>
          </Link>
        </li>
        <li className="sidebar-li">
          <Link
        ...
        <li className="sidebar-li">
          <Link
            className={`sideLink ${
              location.pathname.includes("/quiz-management") ? "active" : ""
            }`}
            to="/quiz-management"
          >
            <span className="sideIcon">
        ...
        <li className="sidebar-li">
          <Link
            className={`sideLink ${
              location.pathname.includes("/notes-management") ? "active" : ""
            }`}
            to="/notes-management"
          >
            <span className="sideIcon">
