...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        document.title = 'IRV Segal | Edit Profile';
                                        ...
                                        <div className="col-lg-6">
                                            <div className="row">
                                                <div className="col-12 mb-3">
                                                    <CustomInput label="Name" labelClass="mainLabel" required type="text" placeholder="Enter Name" inputClass="mainInput" value={userNewData?.name} onChange={(event) => { setUserNewData({ ...userNewData, name: event.target.value }) }} />
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-12 mb-3">
                                                    ...
                                                    <CustomInput label="Email" labelClass="mainLabel" required type="email" placeholder="Phone Number" inputClass="mainInput" value={userNewData?.email} onChange={(event) => { setUserNewData({ ...userNewData, email: event.target.value }) }} />
                                                </div>
                                            </div>
                                            {/* <div className="row">
                                                <div className="col-12 mb-3">
                                            ...
                                            <div className="inputWrapper col-md-8">
                                                <div className="form-controls">
                                                    <label className=" mb-2" htmlFor="">Discripction</label>
                                                    <textarea
                                                        name="content"
                                                        ...
                                                        value={userNewData?.description} onChange={(event) => { setUserNewData({ ...userNewData, description: event.target.value }) }}
